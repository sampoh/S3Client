...
If (Count parameters:C259>=2)
	...
	$fileSize:=getDocumentSize($documentPath)
	...
	Else 
		...
		DOCUMENT TO BLOB:C525($documentPath; $fileBlob)
		
		//シングルパートアップロード
		$request:=signedRequest($params; "PUT"; $path; $fileBlob; ""; ""; New object:C1471("Content-Type"; $contentType))
